 ...
 * @author simmf
 */
public class DettaglioRicettaChs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //URL: DettaglioRicettaChs?prescriptionId=xxx
            ...
            daoFactory.closeConn();
            request.getRequestDispatcher("/WEB-INF/pagine/chs/DettaglioRicettaChs.jsp").forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DettaglioRicettaChs.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
