 ...
 * @author simmf
 */
public class DettaglioVisitaBaseChs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            daoFactory.closeConn();
            request.getRequestDispatcher("/WEB-INF/pagine/chs/DettaglioVisitaBaseChs.jsp").forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DettaglioVisitaBaseChs.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
