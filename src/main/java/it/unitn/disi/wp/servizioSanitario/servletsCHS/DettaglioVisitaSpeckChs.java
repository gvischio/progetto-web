 ...
 * @author simmf
 */
public class DettaglioVisitaSpeckChs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            daoFactory.closeConn();
            request.getRequestDispatcher("/WEB-INF/pagine/chs/DettaglioVisitaSpeckChs.jsp").forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DettaglioVisitaSpeckChs.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
