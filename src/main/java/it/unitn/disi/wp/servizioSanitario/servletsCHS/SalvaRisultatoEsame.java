 ...
 * @author simmf
 */
public class SalvaRisultatoEsame extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //URL: SaltaRisultatoEsame?examId=xxx
//            HttpSession session = request.getSession();
//            int examId = (int) (session.getAttribute("esame"));
            int examId = Integer.parseInt(request.getParameter("examId"));
            System.out.println(examId +" del SalvaRisultatoEsame");
            daoFactory = new DAOFactoryImplementation();
            examDao = daoFactory.getExamDAO();
            exam = examDao.getById(examId);
            
            exam.setResult( request.getParameter("result") );
            
            try{
                examDao.updateRisultatoEsame(exam);
            ...
            daoFactory.closeConn();
            response.sendRedirect("CompilaEsame?examId="+examId);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SalvaRisultatoEsame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
