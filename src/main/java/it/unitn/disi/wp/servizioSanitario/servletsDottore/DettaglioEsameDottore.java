 ...
 * @author simmf
 */
public class DettaglioEsameDottore extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //URL: DettaglioEsameDottore?examId=xxx
            ...
            if (ok) {
                ...
                visit = visitDao.getById(exam.getId());
                ...
                daoFactory.closeConn();            
                request.getRequestDispatcher("/WEB-INF/pagine/dottore/DettaglioEsameDottore.jsp").forward(request, response);
            }
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DettaglioEsameDottore.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
