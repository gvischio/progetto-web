 ...
 * @author simmf
 */
public class DettaglioEsameDottoreToPDF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            System.out.println( "paziente: " + paziente.getId() + " dottore: " + paziente.getFamilydoctor() );
            boolean ok = false;
            try {
                System.out.println("nell'if del controllo");
                User user = (User) session.getAttribute("user");
                System.out.println("dopo aver preso lo user: " + user.getId());
                Dottore dottore = dottoreDao.getById(user.getId());
                System.out.println("Dottore: " + dottore.getId() + " tipo : " + dottore.getType());
