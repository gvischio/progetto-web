...
import it.unitn.disi.wp.servizioSanitario.servletsPaziente.DettaglioVisitaSpeckToPDF;
 ...
 * @author simmf
 */
public class DettaglioVisitaSpeckDottoreToPDF extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DettaglioVisitaSpeckDottoreToPDF.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
