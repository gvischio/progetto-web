 ...
 * @author simmf
 */
public class DisposizionePagata extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                disposition = dispositionDao.getById(id);
            }
            catch (Exception e)
            {
            ...
            Paziente paziente = pazienteDao.getById(disposition.getPatient());
            
            
            dispositionDao.setAsPaid(id);
            daoFactory.closeConn();

            response.sendRedirect("CompilaVisitaSpeck?speckId=" + id);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DisposizionePagata.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
