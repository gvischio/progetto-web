 ...
 * @author simmf
 */
public class HomeDottore extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DottoreDAO dottoreDao = daoFactory.getDottoreDAO();
            Dottore dottore = dottoreDao.getById(user.getId());
            session.setAttribute("dottoreHome", dottore);
            daoFactory.closeConn();
            
            if(dottore.getType() == TypeDoctor.P)
            {
                response.sendRedirect("base/HomeDottoreBase");
            }else if(dottore.getType() == TypeDoctor.S)
            {
                response.sendRedirect("specialista/HomeDottoreSpeck");
            }else
                System.out.println("c'è un errore nell'indirizzare il dottore");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(HomeDottore.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
