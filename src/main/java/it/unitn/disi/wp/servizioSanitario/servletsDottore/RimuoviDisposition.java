 ...
 * @author simmf
 */
public class RimuoviDisposition extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //url: RimuoviDisposition?dispositionId=xxx&visitId=xxx
            ...
            int dispositionId = Integer.parseInt( request.getParameter("dispositionId") );
            ...
            try {
                disposition = dispositionDao.getById(dispositionId);
            }
            catch (Exception e)
            {
                System.out.println(" -> disposizione inesistente");
                daoFactory.closeConn();
                request.getRequestDispatcher("/WEB-INF/pagine/err404.jsp").forward(request, response);
            }
            ...
            try {
                ...
                if(user.getId() != visit.getFamilydoctor() || user.getId() != disposition.getFamilydoctor())
                    throw new Exception(user.getId()+" != "+visit.getFamilydoctor()+" || "+user.getId()+" != "+disposition.getFamilydoctor());
                ok = true;
            }
            catch(Exception e)
            {
            ...
            if (ok) {
                dispositionDao.deleteDispositionById(dispositionId);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RimuoviDisposition.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
