 ...
 * @author simmf
 */
public class SalvaEsitoSpeck extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //url: /restricted/SalvaEsitoSpeck?speckId=xxx
            //l'esito viene preso con una form
            ...
            speckvisita.setResult(esito);
            try {
                speckvisitDao.updateEsitoSpeckvisit(speckId, speckvisita);
            } catch (DaoException ex) {
                Logger.getLogger(SalvaEsitoSpeck.class.getName()).log(Level.SEVERE, null, ex);
                response.sendError(500, ex.getMessage());
            }
            daoFactory.closeConn();
            response.sendRedirect("CompilaVisitaSpeck?speckId=" + speckvisita.getId());
