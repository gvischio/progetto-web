...
public class PrenotaVisita extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Timestamp data = Timestamp.valueOf(request.getParameter("data") );            
            System.out.println("data: " + data + " motivazione: " + motivazione);
            Visit visit = new Visit();
            visit.setFamilydoctor(paz.getFamilydoctor());
            visit.setPatient(paz.getId());
            visit.setMotivation(motivazione);

            daoFactory = new DAOFactoryImplementation();
            visitDao=daoFactory.getVisitDAO();

            System.out.println(visitDao.insertVisitPaziente(visit, data));
            daoFactory.closeConn();
            response.sendRedirect("InfoMedicoPerPaziente");            
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PrenotaVisita.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
