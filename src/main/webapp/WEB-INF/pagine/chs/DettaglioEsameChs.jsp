            ...
            <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2" style="padding-right: 0;padding-left: 0;">
                <div class="card shadow-sm" style="margin-bottom: 15px;">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody style="margin-bottom: -8px;">
                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${requestScope.listaesami.description!=null}"> <td colspan="2" style="width: 60%;"> ${requestScope.listaesami.description} </td> </c:if>
                        ...
                        <a href="${pageContext.servletContext.contextPath}/restricted/chs/DettaglioEsameChsToPDF?examId=${requestScope.exam.id}" target="blank">
