<%-- 
    Document   : DettaglioRicettaDottore
            ...
            <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2" style="padding-right: 0;padding-left: 0;">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="${pageContext.servletContext.contextPath}/restricted/dottore/DettaglioRicettaDottoreToPDF?prescriptionId=${requestScope.prescription.id}" target="blank">
                            <div class="media" style="margin-top: 15px"><img src="../../assetsPazienti/img/pdf.png" class="mr-3 align-self-center" style="width: 40px;cursor: pointer;">
                                <div class="media-body">
                                    <p style="margin-bottom: 0;padding: 10px;">Download dei dettagli della ricetta in formato PDF</p>
                                </div>
                            </div>
                        </a>
                    </div>
