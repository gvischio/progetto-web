<%-- 
    Document   : DettaglioVisitaBaseDottore
            ...
            <div class="col-lg-10 col-xl-10 offset-lg-1 offset-xl-1" style="padding-right: 0;padding-left: 0;">
                <div class="card shadow-sm">
                    <div class="card-header" style="background-color: rgba(0,0,0,0.03);">
                        <h3 class="mb-0">Visita del <script>document.write(FormatDate(new Date('${requestScope.visit.visdate}')));</script> </h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    <c:forEach begin="0" end="${requestScope.tipo.size()-1}" var="i">
                                        <tr>
                                            ...
                                            <c:if test="${requestScope.tipo.get(current)== 'Ricetta'}">
                                                <td class="text-center"><a href="${pageContext.servletContext.contextPath}/restricted/dottore/DettaglioRicettaDottore?prescriptionId=${requestScope.ids.get(current)}"><span style="text-decoration: underline;">dettagli</span></a></td>
                                            </c:if>
                                            <c:if test="${requestScope.tipo.get(current)=='Esame'}">
                                                <td class="text-center"><a href="${pageContext.servletContext.contextPath}/restricted/dottore/DettaglioEsameDottore?examId=${requestScope.ids.get(current)}"><span style="text-decoration: underline;">dettagli</span></a></td>
                                            </c:if>
                                            <c:if test="${requestScope.tipo.get(current)=='Visita Specialistica'}">
                                                <td class="text-center"><a href="${pageContext.servletContext.contextPath}/restricted/dottore/DettaglioVisitaSpeckDottore?speckId=${requestScope.ids.get(current)}"><span style="text-decoration: underline;">dettagli</span></a></td>
                                            </c:if>                                                
                                        </tr>
                                    </c:forEach>
                                </c:if>
                        ...
                        <a href="${pageContext.servletContext.contextPath}/restricted/dottore/DettaglioVisitaBaseDottoreToPDF?visitId=${requestScope.visit.id}" target="blank">
