<%-- 
    Document   : DettaglioVisitaSpeckDottore
            ...
            <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2" style="padding-right: 0;padding-left: 0;">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody style="margin-bottom: -8px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 60%;"><script>document.write(FormatDate(new Date('${requestScope.dataPrescrizione}')));</script></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody style="margin-bottom: -8px;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"> <script>document.write(FormatDate(new Date('${requestScope.dataEsecuzione}')));</script></td>
                                    </tr>
                                    <tr>
                                        <td>Medico</td> 
                        ...
                        <a href="${pageContext.servletContext.contextPath}/restricted/dottore/DettaglioVisitaSpeckDottoreToPDF?speckId=${requestScope.speckvisita.id}" target="blank">
