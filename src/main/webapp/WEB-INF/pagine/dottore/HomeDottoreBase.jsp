<%-- 
    Document   : HomeDottoreBase
    Created on : 21-ago-2019, 16.58.16
    Author     : simmf
--%>
    ...
    <div class="container container-main">
                    ...
                    <div class="card-body shadow">
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10 col-lg-7 col-xl-7"
                                ...
                                <h2 style="margin-bottom: 0px;">Dott. ${requestScope.dottore.firstname} ${requestScope.dottore.lastname}</h2>
                                <h5 class="text-secondary">Medico di base</h5>
                            </div>
                            <div class="col-md-12 col-lg-3 col-xl-3 text-right align-self-end" style="padding-right: 0px;padding-left: 5px;">
                                <a class="btn btn-primary" role="button" href="${pageContext.servletContext.contextPath}/restricted/paziente/HomePaziente" style="margin-right: 5px;">Vai al tuo profilo personale</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                            ...
                            <c:choose>
                                <c:when test="${requestScope.calendario.size()>0}">
                                    <c:forEach begin="0" end="${requestScope.calendario.size()-1}" var="i">
                                        <a href="CompilaVisitaBase?visitId=${requestScope.calendario.get(i).getIdVisita()}">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="border: 0;padding-top: 0px;">
                                                                    <span style="text-decoration: underline;">Motivazione</span>:&nbsp;&nbsp;
            ...
            <div class="col-lg-6 col-xl-5">
                <div class="card shadow" style="margin-bottom: 15px;">
                    <div class="card-header">
                        <h4 class="mb-0">I tuoi pazienti</h4>
                    </div>
                    <div class="card-body">
        ...
        function cerca(find)
        {
            ...
            if(find.length > 0)
            {
                ...
                strs += '</td>' +
                                ...
                                '        <a class="btn btn-secondary btn-sm border rounded shadow-sm" role="button" href="${pageContext.servletContext.contextPath}/restricted/dottore/base/NuovaVisitaDottore?pazienteId=' + item.idpat + '">Nuova visita</a>' +
                                '    </div> </div>';
                    }
                    stampaResults(strs);
                }
