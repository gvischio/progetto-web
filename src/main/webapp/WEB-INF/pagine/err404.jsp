<%-- 
    Document   : err404
    Created on : 3-set-2019, 12.55.24
    Author     : Giacomo
--%>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 col-lg-5 col-xl-4">
                                <p class="text-center" style="font-size: 11em;color: #499cfc;font-family: 'Roboto Mono', monospace;margin-bottom: 0;">404</p>
                            </div>
                            <div class="col">
                                <h1 style="margin-top: 60px;">Oooops! Pagina non trovata</h1>
                                <p style="margin-bottom: 35px;">La pagina che stai cercando non è stata trovata</p>
                                <c:choose>
