<%-- 
    Document   : error
    Created on : 3-set-2019, 12.49.07
    Author     : Giacomo
--%>
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 col-lg-5 col-xl-4 text-center">
                                <img src="assetsPazienti/img/cockroach.png" style="width: 80%;height: auto;margin: 5% auto;max-width: 280px;">
                            </div>
                            <div class="col">
                                <h1 style="margin-top: 58px;margin-bottom: 12px;">Il sistema ha bisogno di una disinfestazione</h1>
                                <p style="margin-bottom: 10px;">Si è verificato un errore imprevisto che ha impedito il corretto caricamento della pagina</p>
                                <p style="margin-bottom: 35px;">Ti invitiamo a riprovare</p>
                                <c:choose>
