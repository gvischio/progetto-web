<%-- 
    ...
    Created on : 17-ago-2019, 13.56.20
    Author     : Mike_TdT
--%>
...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand navbar-expand-lg fixed-top">
            ...
            <c:if test="${!empty PasswordErrate}">
        ...
        <div class="login-dark">
            <form method="POST" action="${pageContext.servletContext.contextPath}/CambioPassword">
                <div class="illustration"><i class="icon ion-ios-locked-outline"></i></div>
                <p align="center"><font size="2">Inserire la nuova password</font></p>
                <div class="form-group"><input name="NewPassword" class="form-control" type="password"></div>
                <p align="center"><font size="2">Inserire di nuovo la password</font></p>
                <div class="form-group"><input name="CheckPassword" class="form-control" type="password"></div>
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" onclick="this.disabled">CAMBIA</button></div>
            </form>
        </div>
